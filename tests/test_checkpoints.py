...
from mcp_witness.storage import WitnessStorage, CHECKPOINT_INTERVAL
...
class TestCheckpoints:
    ...
    async def test_get_checkpoint_for_sequence(self, storage):
        ...
        checkpoint = await storage._maybe_create_checkpoint(9)
    ...
    async def test_merkle_proof_generation(self, storage):
        ...
        proof = await storage.get_merkle_proof(0)
