...
COMPLIANCE_PRESETS: dict[str, CompliancePreset] = {
    "hipaa": CompliancePreset(
        ...
        auto_redact=[
            "patient_name", "patient_dob", "mrn",           # Medical Record Number
            "ssn", "patient_address", "patient_phone",
            "insurance_id", "diagnosis", "treatment_notes",
            "patient_email", "patient_photo",
        ],
    ...
    "gdpr": CompliancePreset(
        ...
        anchor_frequency="daily",
        auto_redact=[
            "email", "phone", "ip_address", "physical_address",
            "full_name", "date_of_birth", "national_id",
            "bank_details", "biometric_data", "location_data",
            "cookie_id", "device_fingerprint",
        ],
        require_attestation=True,
    ...
    "sox": CompliancePreset(
        ...
        auto_redact=[
            ...
            "salary", "equity_grants", "financial_projections",
            "merger_details", "insider_info",
        ],
        require_attestation=True,
    ...
    "fedramp": CompliancePreset(
        ...
        anchor_frequency="daily",
        auto_redact=[
            "ssn", "passport_number", "classified_info",
            "clearance_level", "facility_code", "cui_marking",
        ],
        require_attestation=True,
        immutable=False,
    ...
    "soc2": CompliancePreset(
        ...
        auto_redact=[
            ...
            "session_token", "private_key", "credit_card",
            "customer_pii",
        ],
        require_attestation=True,
        immutable=False,
    ...
    "pci_dss": CompliancePreset(
        ...
        auto_redact=[
            ...
            "cardholder_name", "expiry_date", "track_data",
            "service_code",
        ],
        require_attestation=True,
        immutable=False,
